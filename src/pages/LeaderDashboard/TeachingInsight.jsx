...
const TeachingInsight = () => {
  ...
  return (
    <div className="w-full space-y-6 font-urbanist pb-10">
      ...
      {/* Row 2: Scatter Plot & Priority Areas Grid */}
      ...
      {/* Row 3: Latest Teacher Observation Table */}
      <LatestTeacherObservationTable
        onSetUpClick={() => setIsCreateModalOpen(true)}
      />
      ...
      <CreateObservationModal
        ...
        onSubmitSuccess={(data) => {
          console.log("New observation setup created:", data)
        }}
      />
    </div>
  )
...
export default TeachingInsight