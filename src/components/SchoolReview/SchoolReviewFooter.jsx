  ...
  return (
    <div className="w-full pt-4 pb-2 border-t border-[#EAEAEA] flex items-center justify-between gap-2 sm:gap-4 font-urbanist shrink-0">
      ...
      <button
        ...
        className={`w-9 h-9 sm:w-11 sm:h-11 rounded-full flex items-center justify-center shrink-0 transition-all ${
          currentStep === 1
      ...
      {/* Progress Bar & Step Text (Responsive for Mobile) */}
      <div className="flex-1 min-w-0 flex items-center justify-center gap-1.5 sm:gap-4 max-w-lg mx-1 sm:mx-auto">
        ...
        <span className="text-[11px] sm:text-sm font-medium text-[#1F1F21] whitespace-nowrap shrink-0">
      ...
      <button
        ...
        className={`h-9 sm:h-11 px-4 sm:px-8 rounded-xl font-semibold text-xs sm:text-base shrink-0 transition-all shadow-xs ${
          isNextDisabled
