...
const ExternalObserverNavbar = ({ open, setOpen, user }) => {
    ...
    <header className="w-full h-[68px] min-h-[68px] bg-white border-b border-gray-100 px-4 md:px-8 flex items-center justify-between gap-4 sticky top-0 z-30 font-urbanist shrink-0">
      ...
      <div className="flex items-center gap-4 md:gap-6 relative">
        ...
        <div className="flex items-center gap-2.5 cursor-pointer p-1 rounded-xl hover:bg-gray-50 transition-colors">
          <div className="w-9 h-9 rounded-full overflow-hidden border border-gray-200 shrink-0 bg-gray-100">
            <img
              ...
              onError={(e) => {
                ...
                e.currentTarget.parentElement.innerText = userName ? userName.substring(0, 2).toUpperCase() : "AW"
          ...
          <ChevronDown className="w-4 h-4 text-secondary stroke-[2]" />
        </div>
...
export default ExternalObserverNavbar
