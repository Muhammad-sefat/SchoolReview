...
const ImportTeacherModal = ({ isOpen, onClose }) => {
  const [uploadedFile, setUploadedFile] = useState("teacher.csv")
      ...
      <DialogContent className="max-w-[850px] w-[95vw] rounded-3xl p-6 sm:p-8 space-y-6 bg-white border border-gray-200 shadow-2xl font-urbanist max-h-[90vh] overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <DialogHeader className="p-0 space-y-1 text-left">
          ...
          <p className="text-[16px] font-normal text-textPrimary mt-2">
            Upload and manage your teacher list to control reviews and class assignments.
          </p>
        </DialogHeader>
            ...
            <Table>
              <TableHeader className="bg-gray-100/60">
                <TableRow>
                  ...
                  <TableHead className="text-[16px] font-medium text-[#5A5A5A]">Classes</TableHead>
                  <TableHead className="text-[16px] font-medium text-[#5A5A5A]">Subject(s)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow className="hover:bg-transparent">
                  <TableCell className="text-[16px] font-normal text-[#080808]">John</TableCell>
                  <TableCell className="text-[16px] font-normal text-[#080808]">Smith</TableCell>
                  <TableCell className="text-[16px] font-normal text-[#5A5A5A]">john.smith@school-name.com</TableCell>
                  <TableCell className="text-[16px] font-normal text-[#080808]">1B, 2B, 3A</TableCell>
                  <TableCell className="text-[16px] font-normal text-[#080808]">Chemistry, Math</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
