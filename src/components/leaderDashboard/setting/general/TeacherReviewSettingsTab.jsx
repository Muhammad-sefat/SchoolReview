...
const TeacherReviewSettingsTab = () => {
  const [selectedOption, setSelectedOption] = useState("email_verification")
  ...
  return (
    <div className="space-y-6 font-urbanist">
      <h3 className="text-[20px] font-semibold text-[#080808] px-1">Who Can Submit Teacher Reviews</h3>
