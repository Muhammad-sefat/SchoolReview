...
const LeaderNavbar = ({ open, setOpen }) => {
  ...
  return (
    <header className="w-full h-[68px] min-h-[68px] bg-white border-b border-gray-100 px-4 md:px-6 lg:px-8 flex items-center justify-between gap-4 sticky top-0 z-30 font-urbanist shrink-0">
