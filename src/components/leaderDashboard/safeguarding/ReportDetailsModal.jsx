  ...
  return (
    <>
      <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-fadeIn">
        <div className="bg-white rounded-3xl p-6 md:p-8 max-w-4xl w-full relative space-y-6 shadow-2xl my-8 max-h-[90vh] overflow-y-auto no-scrollbar">
          {/* Header Title & Close Button */}
          <div className="flex items-center justify-between border-b border-dashed border-gray-200/80 pb-4">
            <h2 className="font-urbanist text-2xl font-bold text-[#080808]">
              Report details
            </h2>
            <button
              type="button"
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <div className="relative">
                  ...
                  >
                    <span>
                      Assign to: {assignedTeacher || "(+)"}
                    </span>
                  </button>

                  {/* Assign Teacher Modal Dropdown (Image 3) */}
                  {showAssignModal && (
                    <div className="absolute top-10 left-0 z-40 bg-white border border-gray-200 rounded-2xl p-4 shadow-2xl w-64 space-y-3 animate-fadeIn">
                      ...
                      <button
                        ...
                        className="w-full py-2 rounded-xl bg-[#038AF9] hover:bg-[#0274d4] text-white text-xs font-semibold transition-colors cursor-pointer"
                      >
                        Assign
                      </button>
                    </div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="px-3.5 py-1.5 rounded-full border border-gray-200 bg-white text-xs font-semibold text-[#1F1F21] outline-none cursor-pointer focus:border-[#038AF9]"
                  >
            ...
            <div className="relative w-full border border-gray-200 rounded-2xl p-3 bg-white focus-within:border-[#038AF9] focus-within:ring-2 focus-within:ring-[#038AF9]/20 transition-all">
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="px-6 py-2 rounded-xl bg-[#038AF9] hover:bg-[#0274d4] text-white text-xs font-semibold transition-all shadow-xs cursor-pointer"
                >
                  Next
                </button>
              </div>
          ...
          <div className="border border-gray-100 rounded-3xl p-5 space-y-4 bg-gray-50/20">
            ...
            <div className="ml-auto bg-[#038AF9]/5 border border-[#038AF9]/20 rounded-2xl p-4 text-xs sm:text-sm text-[#1F1F21] leading-relaxed max-w-2xl space-y-2">
              ...
              <p className="text-gray-600">
                Thank you for bringing this to our attention. We're sorry to hear about what you've experienced. Your report has been received and will be reviewed by the school's safeguarding team as a priority. We take reports of online bullying and harassment seriously and will investigate the information you've provided. If there is anything else you would like to share or if the situation changes, please reply to this message. Thank you for speaking up.
              </p>
            </div>
