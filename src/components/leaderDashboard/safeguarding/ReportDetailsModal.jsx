  ...
  return (
    <>
      ...
      <Dialog open={!!report} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="max-w-4xl p-6 md:p-8 max-h-[90vh] overflow-y-auto no-scrollbar rounded-3xl border-none shadow-2xl">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  ...
                  <div className="relative">
                    ...
                    {/* Assign Teacher Modal Dropdown (Image 3 using Shadcn Select) */}
                    {showAssignModal && (
