...
const ScatterPlotModal = ({ isOpen, onClose, metric }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose && onClose()}>
            <DialogContent className="max-w-[1000px] w-[95%] sm:w-full rounded-3xl bg-white p-6 sm:p-8 border border-gray-100 shadow-2xl space-y-5 font-urbanist">
                        ...
                        <div className="flex flex-col mr-3 items-center gap-2 shrink-0">
                            ...
                            <div className="w-7 h-7 rounded-full bg-[#FB8C00] text-white flex items-center justify-center text-[10px] font-bold shadow-2xs">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <g clip-path="url(#clip0_10807_175495)">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_10807_175495">
                ...
                {/* Section 1: Key Insights (Key title 18 normal, key options 18 normal) */}
                ...
                {/* Section 2: Suggested Approaches (Key title 18 normal, key options 18 normal) */}
                <div className="space-y-3">
                    <h4 className="text-[18px] font-medium text-[#080808] font-urbanist leading-snug">
                ...
                {/* Section 3: Bottom 5-Segment Rating Distribution Progress Bars */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    ...
                    <div className="bg-white border border-gray-200/90 rounded-2xl p-3 flex items-center gap-3 shadow-2xs">
                        ...
                        {/* 5 Segment Bar (red: #E53935, 2nd: #FB8C00, 3rd: #90A4AE, 4th: #66BB6A, 5th: #2E7D32) */}
                        <div className="flex-1 flex items-center gap-0.5 h-6 rounded-full overflow-hidden p-0.5 bg-gray-50 border border-gray-100">
                            <div
                                style={{ width: "8%" }}
                                className="h-full bg-[#E53935] text-white text-[9px] font-bold flex items-center justify-center rounded-l-full"
                            >
                                8%
                            </div>
                            <div
                                style={{ width: "10%" }}
                                className="h-full bg-[#FB8C00] text-white text-[9px] font-bold flex items-center justify-center"
                            >
                                10%
                            </div>
                            <div
                                style={{ width: "20%" }}
                                className="h-full bg-[#90A4AE] text-white text-[9px] font-bold flex items-center justify-center"
                            >
                                20%
                            </div>
                            <div
                                style={{ width: "25%" }}
                                className="h-full bg-[#66BB6A] text-white text-[9px] font-bold flex items-center justify-center"
                            >
                                25%
                            </div>
                            <div
                                style={{ width: "37%" }}
                                className="h-full bg-[#2E7D32] text-white text-[9px] font-bold flex items-center justify-center rounded-r-full"
                            >
                                37%
                            </div>
                        </div>
