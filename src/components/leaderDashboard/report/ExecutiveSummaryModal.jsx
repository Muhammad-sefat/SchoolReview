...
const ExecutiveSummaryModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose && onClose()}>
      <DialogContent className="max-w-[760px] w-[95%] sm:w-full rounded-3xl bg-white p-4 border border-gray-100 shadow-2xl space-y-5 font-urbanist max-h-[92vh] overflow-y-auto">
        {/* Modal Header */}
