...
export const Title20Semi = ({ children, className = "" }) => {
    return <p className={`${className} lg:text-[20px] text-base font-urbanist font-semibold leading-7`}> {children} </p>
}

export const Title20 = ({ children, className = "" }) => {
    return <p className={`${className} lg:text-[20px] text-base font-urbanist font-normal leading-6`}> {children} </p>
}

export const Title18 = ({ children, className = "" }) => {
    return <p className={`${className} lg:text-[18px] text-base font-urbanist font-medium leading-7`}> {children} </p>
}

export const Title16 = ({ children, className = "" }) => {
    return <p className={`${className} text-[16px] font-normal font-urbanist leading-6`}> {children} </p>
}