...
// Verified Badge Icon
const VerifiedBadge = () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-[#038AF9] text-white shrink-0">
        <circle cx="12" cy="12" r="10" />
        <path d="m9 12 2 2 4-4" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
);
        ...
        <section className="py-12 lg:py-16 bg-white overflow-hidden font-urbanist select-none">
            <div className="flex flex-col lg:flex-row bg-[#F8F9FA] overflow-hidden border border-gray-100 shadow-xs w-full min-h-[480px]">
                ...
                <div className="w-full lg:w-[35%] bg-[#038AF9] py-8 pl-12 lg:pl-30 flex items-center text-white">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="lg:text-lg text-white/90 mt-3 leading-relaxed max-w-[180px] lg:max-w-none">
                            Explore trusted reviews from parents, <br /> students and teachers.
                        </p>
                        <Link
                            to="/schools"
                ...
                <div className="w-full lg:w-[65%] p-8 sm:p-10 lg:p-12 relative flex items-center bg-[#F8F9FA] overflow-hidden">
                    ...
                    <button
                        ref={prevRef}
                        className="absolute left-2 sm:left-4 lg:left-6 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-md hover:bg-gray-50 flex items-center justify-center transition-all cursor-pointer z-20 disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Previous"
                    >
                    ...
                    <button
                        ref={nextRef}
                        className="absolute right-2 sm:right-4 lg:right-6 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#038AF9] shadow-md hover:bg-blue-600 flex items-center justify-center transition-all cursor-pointer z-20 disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Next"
                    >
                            ...
                            {SCHOOLS_DATA.map((school) => {
                                ...
                                return (
                                    <SwiperSlide key={school.id} className="!h-auto flex">
                                        <div className="w-full bg-white rounded-3xl border border-gray-100 shadow-2xs hover:shadow-xs transition-all overflow-hidden flex flex-col h-full select-none">
                                            ...
                                            <div className="relative w-full aspect-[4/3] overflow-hidden">
                                                ...
                                                >
                                                    <Heart
                                                        className={`w-4.5 h-4.5 transition-colors ${isFavorited ? "fill-[#038AF9] text-[#038AF9]" : "text-[#038AF9]"
                                                            }`}
                                                    />
                                                </button>
                                            </div>
                                            ...
                                            <div className="relative">
                                                <div className="absolute top-0 left-4 -translate-y-1/2 w-10 h-10 bg-white rounded-xl shadow-md border border-gray-100 flex items-center justify-center p-1.5 z-10">
                                                    <img
                                                        src={school.logo}
                                            ...
                                            {/* Card Details */}
                                            <div className="pt-9 pb-5 px-5 flex flex-col justify-between flex-grow gap-3.5">
