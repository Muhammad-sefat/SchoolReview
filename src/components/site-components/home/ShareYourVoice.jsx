  ...
  const SHARE_DATA = [
    {
      ...
      description:
        "Share your school experience. Anonymous feedback from parents, students, and teachers.",
      image: shareVoiceImg,
      path: "/school-review",
    },
    {
      ...
      description:
        "Report concerns safely and anonymously - including bullying and safeguarding issues.",
    ...
    },
    {
      ...
      description:
        "Student-led, anonymous teacher feedback enhanced by AI for clearer, fairer insights.",
    ...
    },
    {
      ...
      description:
        "Recognise strengths and show appreciation with positive feedback that helps teachers grow.",
      image: shareVoiceImg,
      path: "/thank-teacher",
    },
    {
      ...
      description:
        "Empower your school community. Share constructive reviews and suggestions to drive change.",
      image: shareVoice1Img,
      path: "/schools",
    },
  ];
    ...
    <section className="section-padding-x py-12 lg:py-16 bg-white overflow-hidden font-urbanist select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 w-full mb-8">
        ...
        <div className="flex flex-col items-start gap-3">
          {/* Top Badge */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#038AF9]/5 rounded-full text-xs font-medium text-[#038AF9]">
