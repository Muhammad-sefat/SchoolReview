...
const TrustedByTeachers = () => {
  ...
  const TESTIMONIALS_DATA = [
    ...
    },
    {
      id: 2,
      quote:
        "As a parent, I don't want to complain. I want to help. SchoolReview gave me a voice and a constructive way to support my child's school.",
      role: "Parent Voice",
      image: banner1Img,
    },
    {
      id: 3,
      quote:
        "The feedback reminded me why I became a teacher. Some comments made me smile. Others helped me grow.",
      role: "Teacher Voice",
      image: banner2Img,
    },
    {
      id: 4,
      quote:
        "We thought we knew how our school was experienced. The feedback helped us see what we were missing.",
    ...
    },
    {
      id: 5,
      quote:
        "The constructive feedback provided us with actionable insights to build a stronger, more supportive educational environment.",
  ...
  return (
    <section className="section-padding-x py-12 lg:py-16 bg-white overflow-hidden font-urbanist select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 w-full mb-8">
        <h2 className="text-3xl sm:text-4xl lg:text-[36px] font-bold text-textPrimary leading-tight">
        ...
        <div className="flex items-center gap-2.5 mb-1.5 shrink-0">
          <button
            ref={prevRef}
            className="w-8 h-8 rounded-full bg-white shadow-md border border-gray-100 hover:bg-gray-50 flex items-center justify-center transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            title="Previous"
          >
          ...
          <button
            ref={nextRef}
            className="w-8 h-8 rounded-full bg-[#038AF9] shadow-md hover:bg-blue-600 flex items-center justify-center transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            title="Next"
          >
