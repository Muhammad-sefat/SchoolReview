...
import { ChevronLeft, ChevronRight, ChevronDown, Settings, LogOut, User } from "lucide-react"
...
const ReviewSidebar = ({ open, setOpen, collapsed, setCollapsed }) => {
  ...
  const isSettingsActive = location.pathname.includes("/review-dashboard/setting")
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-2 font-urbanist">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3.5 px-3.5 py-2.5 rounded-[10px] text-base transition-all group ${
                isActive || location.pathname === "/review-dashboard" || location.pathname === "/review-dashboard/"
          ...
          >
            <div className="relative shrink-0 flex items-center justify-center">
              <MyFeedbackIcon className="w-5 h-5 text-[#038AF9]" />
              {collapsed && (
            ...
            {!collapsed && (
              <div className="flex items-center justify-between flex-1 truncate">
                <span className="truncate text-[#080808]">My Feedback</span>
          ...
          >
            <User className="w-5 h-5 shrink-0 text-[#1F1F21]" />
          ...
          >
            <FollowedSchoolsIcon className="w-5 h-5 shrink-0 text-[#1F1F21]" />
        ...
        <div className="px-3 py-4 border-t border-gray-100 space-y-1 font-urbanist">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3.5 px-3.5 py-2.5 rounded-[10px] text-base transition-all group ${
                isActive || location.pathname.includes("/review-dashboard/setting")
                  ? "bg-[#FDFDFD] text-[#080808] border border-[#EAEAEA] shadow-2xs font-semibold"
                  : "text-[#5A5A5A] font-medium hover:bg-gray-50"
              } ${collapsed ? "justify-center px-0" : ""}`
            }
          ...
          >
            <Settings className="w-5 h-5 shrink-0 text-[#1F1F21]" />
