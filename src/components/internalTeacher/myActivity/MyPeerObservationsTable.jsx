...
const VideoIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <g clipPath="url(#clip0_10748_203386_my_peer)">
    ...
    <defs>
      <clipPath id="clip0_10748_203386_my_peer">
...
const PEER_TEACHERS_DATA = [
  { id: 1, name: "Albert Flores", period: "10 Oct 2026 – 15 Oct 2026", resources: ["video", "image"] },
  { id: 2, name: "Savannah Nguyen", period: "10 Oct 2026 – 15 Oct 2026", resources: [] },
  { id: 3, name: "Wade Warren", period: "10 Oct 2026 – 15 Oct 2026", resources: ["image"] },
  { id: 4, name: "Kristin Watson", period: "10 Oct 2026 – 15 Oct 2026", resources: ["image", "video"] },
  { id: 5, name: "Ralph Edwards", period: "10 Oct 2026 – 15 Oct 2026", resources: ["video", "image"] },
]

const MyPeerObservationsTable = () => {
  return (
        ...
        <Table className="w-full text-left">
          <TableHeader>
            <TableRow className="border-b border-gray-100 bg-[#FAFAFA]/60 hover:bg-[#FAFAFA]/60">
              ...
              <TableHead className="py-4 px-6 text-[16px] font-normal text-secondary h-auto">
                Start Classroom Observation
              </TableHead>
            </TableRow>
          </TableHeader>

          <TableBody className="divide-y divide-gray-100/80">
            {PEER_TEACHERS_DATA.map((row) => (
              <TableRow
                key={row.id}
              ...
              >
                ...
                {/* Completed Badge matching specified style */}
                <TableCell className="py-5 px-6">
                  <span className="px-4 py-1 rounded-[104px] border border-[#66BB6A] bg-white text-[#66BB6A] text-[14px] font-normal inline-block">
                    Completed
                  </span>
                </TableCell>
              </TableRow>
...
export default MyPeerObservationsTable
