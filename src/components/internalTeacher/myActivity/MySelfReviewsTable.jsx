...
const VideoIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <g clipPath="url(#clip0_10748_203386_my_self)">
    ...
    <defs>
      <clipPath id="clip0_10748_203386_my_self">
...
const SELF_REVIEWS_DATA = [
  { id: 1, name: "Annual Teacher Observation 2026", rating: "4.5", period: "10 Oct 2026 – 15 Oct 2026", resources: ["video", "image"] },
  { id: 2, name: "Annual Teacher Observation 2025", rating: "4.5", period: "10 Oct 2026 – 15 Oct 2026", resources: [] },
  { id: 3, name: "Annual Teacher Observation 2024", rating: "4.5", period: "10 Oct 2026 – 15 Oct 2026", resources: ["video", "image"] },
]

const MySelfReviewsTable = () => {
  return (
          ...
          <TableBody className="divide-y divide-gray-100/80">
            {SELF_REVIEWS_DATA.map((row) => (
              ...
              >
                ...
                {/* Rating with Blue Star SVG */}
                <TableCell className="py-5 px-6">
                  <div className="flex items-center gap-1.5 text-[14px] font-medium text-textPrimary">
                    <BlueStarIcon />
...
export default MySelfReviewsTable
