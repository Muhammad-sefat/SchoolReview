...
const PEER_OBSERVATIONS_DATA = [
  { id: 1, name: "Albert Flores", resources: ["video", "image"], dueDate: "15 Oct 2026" },
  { id: 2, name: "Savannah Nguyen", resources: [], dueDate: "15 Oct 2026" },
  { id: 3, name: "Wade Warren", resources: ["image"], dueDate: "15 Oct 2026" },
  { id: 4, name: "Kristin Watson", resources: ["image", "video"], dueDate: "15 Oct 2026" },
  { id: 5, name: "Ralph Edwards", resources: ["video", "image"], dueDate: "15 Oct 2026" },
]
        ...
        <Table className="w-full text-left">
          ...
          <TableBody className="divide-y divide-gray-100/80">
            {PEER_OBSERVATIONS_DATA.map((row) => (
              ...
              >
                {/* Name Cell: 16px text-textPrimary normal */}
                <TableCell className="py-5 px-6 text-[16px] font-normal text-textPrimary">
                  {row.name}
                </TableCell>

                {/* Action Cell: Start Observation pill */}
                <TableCell className="py-5 px-6">
                  <button
                    type="button"
                    onClick={() => onStartObservation && onStartObservation(row)}
                    className="px-4 py-1 rounded-full border border-[#038AF9] text-[#038AF9] text-[14px] font-normal hover:bg-blue-50 transition-colors cursor-pointer inline-block"
                  >
                    Start Observation
                  </button>
                </TableCell>
                ...
                {/* Due Date Cell: text-textBlack 16px medium */}
                <TableCell className="py-5 px-6 text-[16px] font-medium text-[#080808]">
                  {row.dueDate}
                </TableCell>
              </TableRow>
            ))}
