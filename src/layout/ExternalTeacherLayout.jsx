...
import ExternalSidebar from "../components/ExternalTeacher/common/ExternalSidebar"
import ExternalNavbar from "../components/ExternalTeacher/common/ExternalNavbar"

const ExternalTeacherLayout = () => {
    ...
    <div className="max-w-[1920px] mx-auto">
      ...
      <div className="flex h-screen w-full max-w-full overflow-hidden bg-[#F8FAFC] text-foreground font-urbanist">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          {/* External Teacher Navbar */}
          <ExternalNavbar open={sidebarOpen} setOpen={setSidebarOpen} />
...
export default ExternalTeacherLayout