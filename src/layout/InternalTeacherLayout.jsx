...
import TeacherSidebar from "../components/internalTeacher/common/TeacherSidebar"
import TeacherNavbar from "../components/internalTeacher/common/TeacherNavbar"

const InternalTeacherLayout = () => {
    ...
    <div className="max-w-[1920px] mx-auto">
      ...
      <div className="flex h-screen w-full max-w-full overflow-hidden bg-[#F8FAFC] text-foreground font-urbanist">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          {/* Top Teacher Navbar */}
          <TeacherNavbar open={sidebarOpen} setOpen={setSidebarOpen} />
